...
class TestLab1(unittest.TestCase):
    ...
    def test_bin_search(self):
        ...
        low = 0
        high = len(list_val)-1
        self.assertEqual(bin_search(10, 0, len(list_val), list_val), 10)

    def test_bin_search(self):
        list_val =[]
        low = 0
        high = len(list_val)-1
        self.assertEqual(bin_search(10, 0, len(list_val), list_val), ValueError)

    def test_bin_search(self):
        list_val =[0,1,2,3,4,7,8,9,10]
        low = 0
        high = len(list_val)-1
        self.assertEqual(bin_search(11, 0, len(list_val), list_val), None)    
